...
/**
 * Abstract clase for our webform stripe elements
 */
abstract class StripeWebformElementBase extends WebformElementBase {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    ...
    if (is_numeric($element['#webform_stripe_amount'])) {
      $element['#stripe_amount'] = (int) $element['#webform_stripe_amount'];
    ...
    // We provide potenial default submit buttons based on WebformActions
